                ...
                <form id="contact-form" action="output.php" method="get">
                    ...
                    <div>
                        <label>
                            ...
                            <select id = "severity" name="HIA1" tabindex="8"> 
                    ...
                    <div>
                        <label>
                            ...
                            <select id = "severity" name="HIA2" tabindex="9"> 
                                <option value = "No">No</option> 
                                <option value = "Yes">Yes</option>
                            </select>
                        </label>
                    ...
                    <div>
                        <label>
                            ...
                            <select id = "severity" name="Previous Concusion" tabindex="10"> 
                                <option value = "No">No</option> 
                                <option value = "Yes">Yes</option>
                    ...
                    <div>
                        <label>
                            ...
                            <input placeholder="Please enter how many" type="number" name="Number of Concusions" tabindex="11">
                        </label>
                    </div>
                    <div>
                        <label>
                            ...
                            <input placeholder="Please enter year" type="number" name="Year started playing" tabindex="12">
                        </label>
                    </div>
                    <div>
                        <label>
                            ...
                            <input placeholder="Please enter year" type="number" name="Year started playing professionally" tabindex="13">
                        </label>
                    </div>
                    <div>
                        <label>
                            <span>Player position: (required)</span>
                            <select id = "severity" name="position" tabindex="14"> 
                    ...
                    <div>
                        <label>
                            ...
                            <select id = "severity" name="gameEvent" tabindex="15"> 
                    ...
                    <div>
                        <label>
                            ...
                            <select id = "severity" name="Collision" tabindex="16"> 
                    ...
                    <div>
                        <label>
                            ...
                            <select id = "severity" name="Technique" tabindex="17"> 
                    ...
                    <div>
                        <button type="submit" id="contact-submit" tabindex="20">Next</button>
                    </div>
                </form>
                <!-- /Form -->
